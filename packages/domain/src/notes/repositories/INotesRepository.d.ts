...
export interface INotesRepository {
     ...
     */
    getNotes(userID: string, filters?: NoteFilters, pagination?: PaginationOptions): Promise<Result<PaginatedResult<Note>, Error>>;
    /**
     ...
     * Creates a new note.
     */
    createNote(note: Omit<Note, 'noteID' | 'createdAt' | 'updatedAt'>): Promise<Result<Note, Error>>;
    /**
     * Updates an existing note.
     */
    updateNote(noteID: string, updates: Partial<Note>): Promise<Result<Note, Error>>;
    /**
     ...
     */
    getNotesForEntity(userID: string, entityType: 'task' | 'event' | 'appointment' | 'meeting', entityID: string): Promise<Result<Note[], Error>>;
    /**
...
//# sourceMappingURL=INotesRepository.d.ts.map