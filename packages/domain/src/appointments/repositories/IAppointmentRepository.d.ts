...
export interface IAppointmentRepository {
     ...
     */
    getAppointments(userID: string, filters?: AppointmentFilters, pagination?: PaginationOptions): Promise<Result<PaginatedResult<Appointment>, Error>>;
    /**
     ...
     */
    createAppointment(appointment: Omit<Appointment, 'appointmentID' | 'createdAt' | 'updatedAt'>): Promise<Result<Appointment, Error>>;
    /**
     * Updates an existing appointment.
     */
    updateAppointment(appointmentID: string, updates: Partial<Appointment>): Promise<Result<Appointment, Error>>;
    /**
     ...
     */
    checkConflicts(userID: string, startDateTime: string, endDateTime: string, excludeAppointmentID?: string): Promise<Result<Appointment[], Error>>;
    /**
