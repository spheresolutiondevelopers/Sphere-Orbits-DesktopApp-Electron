...
export interface IMeetingRepository {
     ...
     */
    getMeetings(userID: string, filters?: MeetingFilters, pagination?: PaginationOptions): Promise<Result<PaginatedResult<Meeting>, Error>>;
    /**
     ...
     */
    createMeeting(meeting: Omit<Meeting, 'meetingID' | 'createdAt' | 'updatedAt'>): Promise<Result<Meeting, Error>>;
    /**
     * Updates an existing meeting.
     */
    updateMeeting(meetingID: string, updates: Partial<Meeting>): Promise<Result<Meeting, Error>>;
    /**
     ...
     */
    joinMeeting(meetingID: string, userID: string, participantEmail: string, participantName: string): Promise<Result<{
        meetingLink: string;
    }, Error>>;
    /**
