...
import { 
  Home, CheckSquare, Calendar, Video, Clock, CalendarStar, 
  ChartLine, Users, MessageSquare, StickyNote, Settings, LogOut 
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/events', icon: CalendarStar, label: 'Events', badge: '8' },
